...
function ContactHero({ title, description }: ContactHeroProps) {
    return (
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-700">
            ...
            <div className="space-y-6">
                <ContactInfoItem icon={emailIcon} label="邮箱" value="190615112@qq.com" />
                <ContactInfoItem icon={qqIcon} label="联系QQ" value="190615112" />
            </div>
        </div>
    );
}

function CommunityCard({ title, description, linkUrl, linkText }: CommunityCardProps) {
    return (
...
function GiscusSection({ isLoading }: GiscusSectionProps) {
    return (
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-700">
            {isLoading && (
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col">
            ...
            <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
                    ...
                    <CommunityCard
                        title="加入我们的社区"
                        description="与 10k+ 开发者一起交流。"
                        linkUrl="https://github.com/maxlongint/maxlongint.github.io"
                        linkText="加入 GitHub"
                    />
                </div>

                <GiscusSection isLoading={isLoading} />
            </main>
