...
export default function CompatibilityCard({ packageName }: CompatibilityCardProps) {
    ...
    // 检查是否有任何有用的信息
    const hasInfo = compatibility.node || compatibility.react || compatibility.vue || compatibility.typescript;
    if (!hasInfo) {
        return null;
    }
            ...
            <div className="space-y-3">
                ...
                {compatibility.vue && (
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm font-medium text-gray-900 dark:text-white">{compatibility.vue}</span>
                    </div>
                )}
